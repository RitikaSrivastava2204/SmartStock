...
export default function Dashboard() {
  ...
  const totalWarehouses = new Set(stocks.map((s) => s.warehouseId)).size;
...
function SummaryCard({ label, value, color }) {
  ...
  return (
    <div
      className={`bg-white rounded-xl shadow p-4 border-t-4 ${colors[color]}`}
    >
